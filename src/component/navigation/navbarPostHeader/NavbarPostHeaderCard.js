  ...
  return item && (
    <div className={"w-full h-full relative  min-h-[436px]"}>
      ...
      >
          ...
          { item.categories?.map((x) => {
             return (
                  <div key={x.name} className={"flex items-center flex-row"}>
                    <p
                      className={"truncate-1 text-white ml-[6px] text-[14px] font-roboto font-medium tracking-[0.21px] leading-[16px]"}>#{x.name}</p>
                  </div>
             )
            })}
        </div>
        ...
        <p
          className={
            "text-[14px] font-roboto text-white font-medium tracking-[0.21px] leading-[16px] mt-[14px]"
          }
        >
        ...
        <div
          className={
            "flex flex-col 2xl:flex-row flex-wrap justify-between mt-[30px] items-center"
          }
        >
