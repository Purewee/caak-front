  ...
  return (
    <div className={'flex flex-row items-center justify-center'}>
      ...
      <div
        ...
        className={'w-[20px] h-[20px] flex items-center justify-center cursor-pointer ml-[12px]'}
      >
      ...
      <div
        ...
        className={'w-[20px] h-[20px] relative flex items-center justify-center cursor-pointer ml-[14px]'}
      >
