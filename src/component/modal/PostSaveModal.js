        ...
        <div className='popup_modal-content w-[480px] rounded-[4px] pt-[22px] pb-[20px]'>
          ...
          <div className='w-full px-[24px]'>
            ...
            <div className='w-full flex flex-row justify-end'>
              <p onClick={() => setSavePostOpen(false)} className='cursor-pointer w-[76px] h-[34px] mt-[22px] text-[15px] font-medium rounded-[4px] border border-[#D4D8D8] flex justify-center items-center'>Болих</p>
              <p className='cursor-pointer w-[100px] h-[34px] mt-[22px] text-[15px] font-medium rounded-[4px] text-white ml-[10px] bg-[#FF6600] flex justify-center items-center'>Хадгалах</p>
            </div>
          </div>
        </div>
    </div>
