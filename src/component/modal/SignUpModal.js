        ...
        <div className='popup_modal'>
            {
                ...
                <div className='popup_modal-content w-[720px] h-[620px] rounded-[6px] relative flex flex-row'>
                    ...
                    <div className='w-[430px] relative'>
                        <div className='px-[40px] relative w-full flex flex-col items-center'>
                            ...
                            <button onClick={() => setStep('register')} className='bg-[#FF6600] w-full rounded-[4px] h-[44px] text-[16px] text-white mt-[20px] relative'>
                ...
                <div className='popup_modal-content w-[380px] rounded-[6px] relative'>
                    <div className='px-[40px] relative w-full flex flex-col items-center'>
                        ...
                        <div className='w-full relative mt-[12px]'>
                            <input type={isPasswordShown ? 'text' : 'password'} className='w-full rounded-[4px] bg-[#EFEEEF] h-[44px] pl-[22px] pr-[40px]'  placeholder='Нууц үг давтах'/>
                            <span onClick={() => setIsPasswordShown(!isPasswordShown)} className={`${isPasswordShown ? 'icon-fi-rs-blind' : 'icon-fi-rs-eye'} absolute right-[12px] text-[#BBBEBE] cursor-pointer text-[20px] w-[24px] h-[24px] top-[10px] flex items-center justify-center leading-[24px]`} />
                        </div>
                        <button onClick={() => setStep('confirmation')} className='bg-[#FF6600] w-full flex flex-row items-center justify-center rounded-[4px] h-[44px] text-[16px] text-white mt-[22px] relative'>
                            Бүртгүүлэх
                        </button>
                    </div>
                    {/* footer */}
