  ...
  return isFooter ? (
    <div className='w-full md:h-[423px] bg-[#111111] flex flex-col sm:items-center justify-between'>
            ...
            <Collapse className="w-full custom bg-caak-black" bordered={false} accordion={true}>
                ...
                >
                    <div className='flex flex-col gap-[10px] justify-between items-center px-[16px] text-[15px] text-[#838383] pb-[30px]'>
                        <p onClick={() => window.location.href='/help/0'} className='cursor-pointer hover:text-[#FF6600]'>Холбоо барих</p>
                        <p className='cursor-pointer hover:text-[#FF6600]' onClick={() => window.location.href='/help/1'}>Сурталчилгаа</p>
                        <p className='cursor-pointer hover:text-[#FF6600]' onClick={() => window.location.href='/help/2'}>Контент нийлүүлэх</p>
                    </div>
                </Collapse.Panel>
                <Collapse.Panel
                    style={{borderBottomColor: '#1f1e1e'}}
                ...
                >
                    <div className='flex flex-col gap-[10px] px-[16px] justify-between items-center text-[15px] text-[#838383] pb-[30px]'>
                        <p className='cursor-pointer hover:text-[#FF6600]' onClick={() => window.location.href='/help/0'}>Бидний тухай</p>
                        <p className='cursor-pointer hover:text-[#FF6600]' onClick={() => window.location.href='/help/4'}>Үйлчилгээний нөхцөл</p>
                        <p className='cursor-pointer hover:text-[#FF6600]' onClick={() => window.location.href='/help/3'}>Нууцлалын бодлого</p>
                    </div>
                </Collapse.Panel>
        ...
        <div className='hidden sm:flex flex-col md:flex-row w-full items-start max-w-[1310px] px-[16px] md:px-0'>
            ...
            <div className='w-full flex flex-col md:flex-row gap-[16px] justify-between mt-[30px] md:mt-[60px]'>
                ...
                <div>
                    ...
                    <div className='h-[86px] flex flex-col justify-between text-[15px] text-[#838383] mt-[20px]'>
                        <p className='cursor-pointer hover:text-[#FF6600]' onClick={() => window.location.href='/help/2'}>Холбоо барих</p>
                        <p className='cursor-pointer hover:text-[#FF6600]' onClick={() => window.location.href='/help/1'}>Сурталчилгаа</p>
                        <p className='cursor-pointer hover:text-[#FF6600]' onClick={() => window.location.href='/help/2'}>Контент нийлүүлэх</p>
                    </div>
                </div>
        ...
        <div className='border-t border-[#3B3B3B] flex justify-center w-full py-[20px] md:py-[40px]'>
            <p className='text-[#838383] text-[15px] whitespace-nowrap'>©{year} “Саак Холдинг” ХХК</p>
        </div>
    </div>
  )
   :
