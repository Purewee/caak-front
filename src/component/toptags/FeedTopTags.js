...
const posts = [
  ...
  },
  {
    ...
    name: 'Спорт',
    image:
      'https://upload.wikimedia.org/wikipedia/commons/thumb/2/24/Blackpink_PUBG_210321.jpg/1200px-Blackpink_PUBG_210321.jpg',
  },
  {
    id: 4,
    name: 'Хөгжилтэй',
  ...
  },
  {
    ...
    name: 'Монгол',
    image:
      'https://ichef.bbci.co.uk/news/1024/cpsprodpb/1858C/production/_109642799_3f7a7888-11b4-42ad-8606-e9eae919d71d.jpg',
  },
  {
    id: 6,
    name: 'Аялал',
    image:
      'https://releasedate.news/wp-content/uploads/2022/03/BLACKPINK-2022-Comeback-New-Project-Announced-Jeon-So-Mi-accidentally.jpg',
  },
  {
    id: 7,
    name: 'Технологи',
    image:
      'https://lh3.googleusercontent.com/tFVNartbFTOK-Y7_MBbVSFRNtCuRGQyhWWHxe3TeQAPpVnpgB-NQpYtwMOiHED-wI84gAnW3cWnr6FRMA-pDOrYPAHFsTZE_6eo=w780-nu-rj-l80-e365',
  },
  {
    id: 8,
    name: 'Хоол',
  ...
  },
  {
    ...
    name: 'ХАХАХАХ',
    image:
      'https://cdn.i-scmp.com/sites/default/files/styles/og_twitter_scmp_analysis/public/d8/images/methode/2020/06/08/4b0bdfc6-a639-11ea-8ea0-d7434be00753_image_hires_121748.jpg?itok=pAUflAeJ&v=1591589877',
  },
];
    ...
    <div className="bg-[#F5F5F5] w-full flex justify-center py-[50px]">
      ...
      >
        ...
        <div className="flex flex-row items-center">
          ...
          <p className={'font-bold text-[#000000] ml-[8px] text-[24px] leading-[28px]'}>ШИЛДЭГ ТАГУУД</p>
        </div>
        <div ref={trendPostsRef} className={'trendPostsCardWrapper relative mt-[20px] overflow-x-scroll'}>
          <div className={' flex flex-row flex-nowrap gap-[13px] w-full h-full transition-all duration-300'}>
