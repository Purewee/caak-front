    ...
    <div className="w-full pt-[21px] flex justify-center">
      ...
      >
        ...
        <div ref={trendPostsRef} className={'trendPostsCardWrapper relative overflow-x-scroll'}>
          <div className={' flex flex-row flex-nowrap w-full h-full gap-[21px] transition-all duration-300'}>
            <div className="min-w-[348px] max-w-[348px] h-[227px] relative">
              ...
              <div className="absolute bg-white z-10 top-[5px] left-[5px] w-[338px] h-[218px] rounded-[4px] border-[1px] border-[#D4D8D8]"></div>
              <div className="absolute z-0 bg-white top-[10px] left-[10px] w-[338px] h-[217px] rounded-[4px] border-[1px] border-[#D4D8D8]"></div>
            </div>
