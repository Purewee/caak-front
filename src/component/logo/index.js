...
const Logo = ({ navBarStyle, className, mobile }) => {
  return (
    <div className={`relative flex flex-shrink-0 flex-row items-center ${className}`}>
      <Link to={'/'}>
        <div
          className={`${mobile ? 'w-[110px] h-[33px]' : 'w-[140px] h-[42px]'} flex flex-shrink-0 flex-row items-center`}
        >
          <img
