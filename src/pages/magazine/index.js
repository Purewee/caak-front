...
export default function Magazine({ owned }) {
  ...
  return (
    <div className="py-[31px] flex flex-col items-center w-full">
      <img
        className="w-[800px] h-[360px] rounded-[10px] object-cover"
        alt=""
        src="https://namastehallyu.com/wp-content/uploads/2021/03/suzynamastehallyu.jpg"
      />
      ...
      <div className="text-[#555555] text-[15px] leading-[18px] flex flex-row items-center mt-[10px]">
        жор үүсгэсэн:
        <div className="text-[#111111] font-medium flex flex-row items-center ml-[8px]">
          <img
            className="h-[22px] w-[22px] rounded-full object-cover mr-[6px]"
            alt=""
            src="https://i.mydramalist.com/pOqyQf.jpg"
          />
          Sam Dorj
        </div>
      </div>
      <p className="text-[#555555] text-[15px] mt-[20px]">
      ...
      <div className="flex flex-row text-[#555555] mt-[20px] text-[15px] leading-[18px]">
        ...
        <p>
          <span className="text-[#111111] font-medium ml-[20px]">132</span> Хандалт
        </p>
      </div>
      {owned ? (
      ...
      <div className={'relative max-w-[1310px] w-full justify-items-center newFeedGrid justify-center mt-[50px]'}>
