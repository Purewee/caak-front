...
const Reclam = [
  ...
  },
  {
    ...
    title:
      'Таны сурталчилгаа, постыг хэрэглэгчийн нүдэнд өртөх боломжтой бүх газар харуулах бөгөөд нийгмийн сүлжээгээр (facebook, twitter)-ээр үнэ төлбөргүй түгээнэ.',
    color: '#F2F1DF',
    textColor: '#5D5B42',
  },
  {
  ...
  },
  {
    ...
    title:
      'Хагас болон Бүтэн жилээр баннер байршуулах бол танай байгууллагт зориулан хямдарсан тусгай БАГЦ ҮНИЙН САНАЛЫГ гаргаж өгнө.',
    color: '#F3DEDE',
    textColor: '#813333',
  },
];
  ...
  return (
    <div className="w-full flex flex-col items-center bg-[#F5F5F5]">
      <div className="w-full h-[230px] md:h-[340px] bg-[#463146] flex justify-center px-[16px]">
        <div className="max-w-[1310px] w-full flex flex-row justify-between items-center">
          <div className="max-w-[480px] w-full">
            <p className="text-[35px] md:text-[52px] text-white condMedium leading-[41px] md:leading-[54px]">
              Бусдаас өөр мэдрэмж!
            </p>
            <p className="max-w-[372px] w-full text-white text-[18px] leading-[23px] text-opacity-80 mt-[30px]">
              Дотоод, гадаадын шилдэг, шинэ мэдээллүүдийг нэг цэгээс хүргэнэ!
            </p>
          </div>
      ...
      <div className="max-w-[1310px] w-full flex flex-col sm:flex-row mt-[30px] sm:mt-[60px] justify-between mb-[87px] px-[16px] md:px-0">
        <div
          style={{ boxShadow: '0px 2px 2px #00000010' }}
          className={`w-[290px] bg-[#FFFFFF] border ${
            selected !== 1 && 'sm:sticky top-[60px]'
          } border-[#EFEEEF] h-[270px] rounded-[4px] p-[10px]`}
        >
          {Tabs.map((data, index) => {
            return (
              <div
                ...
                key={index}
                className={`flex flex-row items-center pl-[14px] cursor-pointer h-[50px] ${
                  selected === index && 'bg-[#FF6600] bg-opacity-10 rounded-[2px]'
                }`}
              >
                <span
                  className={`${data.icon} w-[22px] h-[22px] text-[20px] flex justify-center items-center ${
                    selected === index ? 'text-[#FF6600]' : 'text-[#909090]'
                  }`}
                />
                <p
                  className={`ml-[10px] text-[16px] leading-[19px] ${
                    selected === index ? 'text-[#FF6600] font-medium' : 'text-[#111111]'
                  }`}
                >
                  {data.name}
                </p>
        ...
        <div className="max-w-[960px] w-full">
          {selected === 0 ? (
            <div>
              <p className="font-condensed font-bold text-[32px] text-[#111111] leading-[38px] mt-[20px] sm:mt-0">
                Бидний тухай
              </p>
              <div className="flex flex-col justify-between mt-[20px] text-[#555555]">
                <p className="text-[15px] leading-[20px]">
                  Саак.мн сайт нь 2006 оны 1-р сарын 23-аас эхэлж үйл ажиллагаагаа явуулж эхэлсэн бөгөөд Гадаад дотоодын
                  сонин содон, сонирхолтой баримт, гэрэл зургуудыг хүргэсээр ирсэн Монголын анхны энтертаймент сайт
                  билээ.
                </p>
            ...
            <div>
              <p className="font-condensed font-bold text-[25px] md:text-[32px] text-[#111111] md:leading-[38px] mt-[20px] sm:mt-0">
                Сурталчилгаа байршуулах
              </p>
              <p className="text-[15px] text-[#555555] leading-[20px] mt-[23px]">
                Та манай 16 жилийн түүхтэй CAAK.MN сайт дээр Мэдээ, Пост, Контент нийтлүүлэх болон бизнесийн
                сурталчилгаа байршуулснаар дараах давуу талуудыг хүртэх боломжтой.
              </p>
              ...
              <div className="flex flex-wrap justify-center sm:justify-between gap-[20px] mt-[20px]">
                {Reclam.map((data, index) => {
                  return (
                    <div
                      key={index}
                      style={{ boxShadow: '0px 2px 2px #0000000F', backgroundColor: data.color }}
                      className={`w-[306px] flex flex-col pt-[20px] pb-[14px] rounded-[4px] px-[20px]`}
                    >
                      <span
                        style={{ color: data.textColor }}
                        className={`${data.icon} w-[20px] h-[20px] text-[18px] flex justify-center items-center`}
                      />
                      <p style={{ color: data.textColor }} className="text-[15px] leading-[19px] mt-[8px] font-medium">
                        {data.title}
                      </p>
                    </div>
                  );
            ...
            <div>
              ...
              <div className={`flex flex-row items-center text-[#555555] mt-[14px]`}>
                <span
                  className={`icon-fi-rs-location-o w-[24px] h-[24px] text-[22px] flex justify-center items-center`}
                />
                <p className="ml-[10px] text-[15px] leading-[18px]">
                  Улаанбаатар, Хан-Уул дүүрэг, 17-р хороолол “Кинг тауэр”, 121/102
                </p>
              </div>
            </div>
          ) : selected === 3 ? (
            <div>
              ...
              <p className="mt-[20px] text-[15px] leading-[21px] text-[#555555]">
                Caak.mn нь үйлчүүлэгчдийнхээ мэдээллийн нууцлалыг нэн тэргүүнд чухалчлан үзэж халдашгүй байдлыг бүхий л
                сүлжээний харилцаанд бүрэн хангадаг. Бид манайд харьяалагддаггүй бусад компани хувь хүмүүсийн
                үйлчилгээнд ямар нэгэн баталгаа өгөхгүй. Та манай цахим хуудсаар үйлчлүүлж манай үйлчлүүлэгч болох нь
                дараах нууцлалын баталгааг хүлээн зөвшөөрсний илрэл юм.
              </p>
            ...
            <div>
              ...
              <ol className="mt-[20px]">
                <li className="text-[#363946] text-[20px] font-bold">
                  Ерөнхий зүйл
                  <ol className="mt-[20px] text-[15px] text-[#555555] leading-[22px] font-normal">
                    <li>
                      Caak.mn сайтыг болон түүнд агуулагдаж байгаа бүх текст, фото, график, видео, дуу авианы
                      контентуудыг бүхэлд нь "Саак Холдинг" ХХК хариуцдаг болно. Хэрэглэгч нь энэхүү журамд нийцүүлэн уг
                      сайтыг хэрэглэх ёстой.Хэрвээ дурдсан нөхцлүүдийг зөвшөөрөхгүй бол сайтад хандах болон хэрэглэхээс
                      татгалзахыг зөвлөж байна.
                    </li>
                    <li>
                      Саак Холдинг" ХХК нь үйлчилгээний нөхцөлд хүссэн үедээ өөрчлөлт хийх бүрэн эрхтэй. Хийгдсэн
                      өөрчлөлтүүд нь сайтад нийтлэгдсэн мөчөөс хүчин төгөлдөр үйлчилнэ. Хэрэглэгч нь нөхцөлд орсон
                      өөрчлөлтийг нийтлэгдсэнээс хойш хэрэглэвэл хүлээн зөвшөөрсөнд тооцогдоно.
                    </li>
                    <li>
                      Саак Холдинг" ХХК нь сайтын агуулга, үйлчилгээний бүтэц, хэлбэр загвар зэрэгт хүссэн үедээ, хүссэн
                      өөрчлөлт шинэчлэлтээ хийх эрхтэй.
                    </li>
                  </ol>
                </li>
                <li className="text-[#363946] text-[20px] font-bold mt-[40px]">
                  Оюуны өмчлөл
                  <ol className="mt-[20px] text-[15px] text-[#555555] leading-[22px] font-normal">
                    <li>
                      Сайтад нийтлэгдсэн текст, дуу авиа, график зураг, лого, фото, видео болон бусад бүх контентуудын
                      оюуны өмчлөл нь Монгол Улсын холбогдох хууль тогтоомжийн дагуу баталгаажсан болно.
                    </li>
                    <li>
                      Сайтын аливаа контентыг хэрэглэгч нь зөвхөн хувийн хэрэгцээндээ ашиглах эрхтэй. “Саак Холдинг”
                      ХХК-ийн зөвшөөрөлгүйгээр контентыг хувилж тараах, нийтлэх, арилжааны зорилгоор ашиглахыг
                      хориглоно.{' '}
                    </li>
                    <li>
                      Хэрэглэгч нь сайтын аливаа контентыг хуулж, татаж авснаар өмчлөх эрх шилжихгүй гэдгийг анхааруулж
                      байна.
                    </li>
                  </ol>
                </li>
                <li className="text-[#363946] text-[20px] font-bold mt-[40px]">
                  ...
                  <ol className="mt-[20px] text-[15px] text-[#555555] leading-[22px] font-normal">
                    ...
                    <li>
                      эдгээр контентууд нь тус тусын зохиогч, өмчлөгчтэй байх ба сайт нь гэрээний нөхцлөөс гадуур
                      эзэмших эрхгүй.
                    </li>
                    <li>
                      Гуравдагч этгээдийн контентод туссан санаа, үзэл бодол, үнэн зөв байдал, байр суурийн өмнөөс сайт
                      нь хариуцлага хүлээхгүй. Хэрэглэгч нь эдгээр контентын үнэн зөв байдал, байр суурь зэрэгт хувийн
                      үнэлэлт дүгнэлтээ өгөх үүрэгтэй.
                    </li>
                  </ol>
                </li>
                <li className="text-[#363946] text-[20px] font-bold mt-[40px]">
                  ...
                  <ol className="mt-[20px] text-[15px] text-[#555555] leading-[22px] font-normal">
                    ...
                    <li>
                      Хэрэглэгч болон сурталчлагч байгууллагын хоорондын харилцаанд Сайт огт оролцохгүй ба үүнтэй
                      холбоотой үүссэн аливаа маргаан, үл ойлголцолд Сайт хариуцлага хүлээхгүй.
                    </li>
                  </ol>
                </li>
                <li className="text-[#363946] text-[20px] font-bold mt-[40px]">
                  ...
                  <ol className="mt-[20px] text-[15px] text-[#555555] leading-[22px] font-normal">
                    <li>
                      Сайтад нийтлэгдсэн “Саак Холдинг” ХХК-нд харъяалагдах бүх үйлчилгээ, бүтээгдэхүүний барааны
                      тэмдэгт нь тус компаний өмчид тооцогдоно.
                    </li>
                    <li>
                      Сайтад нийтлэгдсэн гуравдагч этгээдүүдийн барааны тэмдэгтүүд нь тус тусын эзэмшигчдийн өмчид
                      тооцогдоно.
                    </li>
                  </ol>
                </li>
      ...
      {selected === 1 && (
        <div className="bg-white pt-[50px] flex justify-center w-full px-[16px] md:px-0">
          <div className="max-w-[1310px] w-full flex flex-col items-center">
            <div
              style={{ boxShadow: '0px 3px 8px #0000001A' }}
              className="w-full h-[68px] border border-[#D4D8D8] flex flex-row justify-center items-center rounded-[4px]"
            >
              ...
              {caakAds.map((data, index) => {
                return (
                  <div
                    ...
                    key={index}
                    style={{ boxShadow: hovered === index ? '0px 2px 16px #00000033' : '0px 2px 2px #0000000F' }}
                    className="w-full sm:w-[310px] h-[304px] border border-[#D4D8D8] rounded-[4px] p-[20px] flex flex-col justify-between"
                  >
                    <div>
                      <p className="w-[40px] h-[40px] rounded-[2px] bg-caak-primary bg-opacity-10 flex justify-center items-center text-caak-primary text-[22px] font-bold leading-[25px]">
                        {data.pos}
                      </p>
                    ...
                    <button
                      onClick={() => setOpen(data.pos)}
                      className="bg-[#3B4491] text-white text-[16px] font-medium w-full h-[44px] rounded-[4px]"
                    >
                      Жишээ үзэх
                    </button>
                  </div>
            ...
            <div className="flex flex-wrap justify-center gap-[28px] w-full mt-[31px]">
              {moneyNews.map((data, index) => {
                return (
                  <div
                    onMouseEnter={() => toggleHoverNews(index)}
                    onMouseLeave={() => setHoveredNews(false)}
                    key={index}
                    style={{ boxShadow: hoveredNews === index ? '0px 2px 16px #00000033' : '0px 2px 2px #0000000F' }}
                    className="w-full sm:w-[418px] h-[316px] border border-[#D4D8D8] rounded-[4px]"
                  >
                    <div className="w-full h-[113px] relative rounded-t-[4px]">
                      <img alt="" src={data.pic} className="w-full h-full object-cover" />
                      <p className="bg-black bg-opacity-30 h-full w-full text-white text-[20px] font-bold absolute top-0 flex justify-center items-center">
                        {data.pos}
                      </p>
                    </div>
