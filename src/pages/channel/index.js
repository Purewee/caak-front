...
export default function Channel() {
    ...
    return (
        <div className='flex flex-col w-full items-center'>
            <img className='w-[94px] h-[94px] rounded-full mt-[51px]' alt='' src='https://cdna.artstation.com/p/assets/images/images/049/505/328/large/constantine-sekeris-konshu-03b.jpg?1652671392' />
            ...
            <div className='flex flex-row items-center mt-[18px] text-[15px]'>
                <p className='text-[#555555] leading-[18px]'><span className='text-[#111111] font-medium'>8</span> Пост</p>
                <p className='text-[#555555] leading-[18px]'><span className='text-[#111111] font-medium ml-[20px]'>30</span> Дагагчид</p>
            </div>
            <div className='flex flex-row items-center mt-[20px]'>
                <button className='w-[90px] h-[34px] bg-[#FF6600] rounded-[4px] text-white text-[15px] font-bold'>
                    Дагах
                </button>
