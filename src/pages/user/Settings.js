            ...
            <div className='max-w-[1140px] w-full mt-[51px]'>
                <div className='flex flex-col md:flex-row gap-[20px] md:gap-[60px]'>
                    ...
                    <div className='w-full md:w-[790px] mt-[46px]'>
                        <div className='border-[#EFEEEF] border rounded-[4px] w-full p-[15px] md:p-[30px]'>
                        ...
                        <div className='border-[#EFEEEF] border rounded-[4px] w-full p-[15px] md:p-[30px] mt-[30px]'>
                            <p className='text-[22px] font-bold leading-[25px] w-full border-b border-[#D4D8D8] pb-[14px]'>Мэдээний төрөл</p>
                            <div className='mt-[24px] flex gap-[10px] flex-wrap justify-between'>
                                <div className='w-full md:w-[172px] h-[100px] rounded-[6px] relative cursor-pointer zoom'>
                                ...
                                <div className='w-full md:w-[172px] h-[100px] rounded-[6px] border border-caak-primary bg-[#FFF9F5] flex flex-col items-center justify-center'>
