          ...
          <table className="w-full mt-[40px] mb-[40px] border border-[#EFEEEF]">
            <thead className="h-[44px]">
              <tr className="bg-[#F5F5F5]">
                <th className="w-full text-left text-[#555555] font-medium text-[15px] pl-[20px]">Мэдээ</th>
