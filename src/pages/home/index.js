        ...
        <div className="sticky md:hidden top-0 z-50 w-full bg-white">
          <div className="w-full border-b-[3px] border-[#EFEEEF] h-[36px] mt-[21.7px] relative">
            <div className="pr-[25px] absolute left-0 wrapper w-full"> 
              <p onClick={() => setSelected(0)} className={`${selected === 0 && 'border-b-[3px] border-[#FF6600]'} ml-[16px] text-[21px] font-bold text-[#111111] uppercase whitespace-nowrap`}>ШИНЭ</p>
              <p onClick={() => setSelected(1)} className={`ml-[16px] text-[21px] ${selected === 1 && 'border-b-[3px] border-[#FF6600]'} font-bold text-[#111111] uppercase whitespace-nowrap`}>ТРЭНД</p>
              {
...
<<<<<<< HEAD
        {selected === 0 ? (
          <div className="w-full flex flex-col items-center">
            <div
              className={`relative max-w-[1310px] w-full justify-items-center pt-[18px] border-t-[8px] xl:border-none border-[#EFEEEF] xl:mt-[50px] ${
        ...
        <div className='w-full flex flex-col items-center'>
          {
            ...
            <div className='w-full flex flex-col items-center'>
              <div
                className={
                  `relative max-w-[1310px] w-full pt-[18px] xl:pt-[50px] justify-items-center ${isMobile ? 'mobileFeedGrid' : 'HighlightFeedGrid'} justify-center`
                }
              >
                {
                  articles.slice(0, 2).map((data, index) => {
                    if(isLaptop){
                      return(
                        <BigTrendCard key={index} post={data} index={index} />
                      )
                    }else{
                      return(
              ...
              <div
                className={
                  `relative max-w-[1310px] w-full justify-items-center pt-[18px] xl:pt-[40px] ${isMobile ? 'mobileFeedGrid' : 'trendGrid'} justify-center`
                }
              >
                {
                  articles.slice(2, 10).map((data, index) => {
                    return(
                      <TrendCard key={index} post={data} index={index} />
                    )
                  })
                }
              </div>
          ...
          <div
            className={
              `relative max-w-[1310px] w-full justify-items-center pt-[18px] border-t-[8px] xl:border-none border-[#EFEEEF] ${selected === 1 ? 'xl:pt-[60px]' : 'xl:pt-[50px]'} ${isMobile ? 'mobileFeedGrid' : 'newFeedGrid'} justify-center`
            }
          >
            {
              articles.slice(0, 5).map((data, index) => {
